public class AC3_arc
{
	...
	public AC3_arc(DATA indata)
	{
		...
		/////////////////////////////////////////////////////////////////////////////////////////////
	     heap=new int[data.constraintN*2+1][2];
	     inheap=new int[data.constraintN][data.varN];
	     for(int i=0;i<data.constraintN;i++)
	     {
